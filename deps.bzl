...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_sbzhu_weworkapi_golang",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/sbzhu/weworkapi_golang",
        sum = "h1:XGmsfwnqoYU4PIcLFusOe6mJWb6p9iuj1OT7b1/9diY=",
        version = "v0.0.0-20210525081115-1799804a7c8d",
    )
    ...
    go_repository(
        name = "com_github_wenerme_go_req",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/wenerme/go-req",
        sum = "h1:4/6Qqg+E8z98SCi21dFnhL6goSWOYMunJkMc+YanrEw=",
        version = "v0.0.0-20210907160348-d822e81276bb",
    )
