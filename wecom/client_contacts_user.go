...
func (c *Client) CreateUser(r *CreateUserRequest) (out GenericResponse, err error) {
...
func (c *Client) UpdateUser(r *UpdateUserRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) DeleteUser(r *DeleteUserRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) BatchDeleteUser(r *BatchDeleteUserRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) SimpleListUser(r *SimpleListUserRequest) (out SimpleListUserResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) ListUser(r *ListUserRequest) (out ListUserResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) ConvertToOpenID(r *ConvertToOpenIDRequest) (out ConvertToOpenIDResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) AuthSuccess(r *AuthSuccessRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) BatchInvite(r *BatchInviteRequest) (out BatchInviteResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) GetJoinQrcode(r *GetJoinQrcodeRequest) (out GetJoinQrcodeResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) GetActiveStat(r *GetActiveStatRequest) (out GetActiveStatResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
