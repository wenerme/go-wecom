...
func (c *Client) CreateDepartment(r *CreateDepartmentRequest) (out CreateDepartmentResponse, err error) {
...
func (c *Client) UpdateDepartment(r *UpdateDepartmentRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) DeleteDepartment(r *DeleteDepartmentRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) ListDepartment(r *ListDepartmentRequest) (out ListDepartmentResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
