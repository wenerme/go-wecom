...
func (c *Client) GetPreAuthCode(r *GetPreAuthCodeRequest) (out GetPreAuthCodeResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "GET",
...
func (c *Client) SetSessionInfo(r *SetSessionInfoRequest) (out GenericResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) GetPermanentCode(r *GetPermanentCodeRequest) (out GetPermanentCodeResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) GetAuthInfo(r *GetAuthInfoRequest) (out GetAuthInfoResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) GetCorpToken(r *GetCorpTokenRequest) (out GetCorpTokenResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
...
func (c *Client) GetAdminList(r *GetAdminListRequest) (out GetAdminListResponse, err error) {
	err = c.Request.With(req.Request{
		Method: "POST",
